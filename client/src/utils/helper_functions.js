...
export const writeText = function (info, style = {}, medium) {
	const { text, x, y } = info;
	const {
		fontSize = 40,
...
export const writeDetails = function (text, medium, ctx) {
	writeText(
...
export const createElement = function (id, x1, y1, x2, y2, type, color) {
	let roughElement;
	if (type === 'line') {
		roughElement =
			color === 'none'
